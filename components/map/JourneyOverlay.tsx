...
import { getActiveJourneys } from '@/api/journeys/journeyApi';
import { getCurrentUser } from '@/api/user/userApi';
import { getGroupById, getUserGroups } from '@/api/group/groupApi';
...
export default function JourneyOverlay({ onStartJourney }: Props) {
  ...
  // Si hay journey activo, mostrar información del journey
  if (activeJourney) {
  ...
  // Si se han expandido las opciones, mostrar opciones de grupo
